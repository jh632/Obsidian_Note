...
- [x] [[#7.1 上电后硬件自动做了哪两件事？为什么顺序不能反？|上电后硬件自动做了哪两件事？为什么顺序不能反？]] ✅ 2026-08-12
- [x] [[#7.2 向量表的第 0、1、2 项分别是什么？为什么第 0 项不是函数地址？|向量表的第 0、1、2 项分别是什么？为什么第 0 项不是函数地址？]] ✅ 2026-08-12
- [x] [[#7.3 data 段为什么要从 Flash 搬到 RAM？bss 段为什么要清零？|.data 段为什么要从 Flash 搬到 RAM？.bss 段为什么要清零？]] ✅ 2026-08-12
- [x] [[#7.4 SystemInit 和 __main 各负责什么？main 是谁调用的？|`SystemInit()` 和 `__main()` 各负责什么？`main()` 是谁调用的？]] ✅ 2026-08-12
- [x] [[#7.5 为什么 Bootloader 不能升级自身？|为什么 Bootloader 不能升级自身？]] ✅ 2026-08-12
- [x] [[#7.6 跳转 App 的五步分别是什么？漏掉任一步的后果？|跳转 App 的五步分别是什么？漏掉任一步的后果？]] ✅ 2026-08-12
- [x] [[#7.7 VTOR 是什么？地址是多少？为什么跳转时一定要改它？|VTOR 是什么？地址是多少？为什么跳转时一定要改它？]] ✅ 2026-08-12
- [x] [[#7.8 单区升级为什么可能变砖？A/B 方案如何解决？|单区升级为什么可能变砖？A/B 方案如何解决？]] ✅ 2026-08-12
- [x] [[#7.9 CRC32 / SHA256 / 数字签名 / 版本号各自的防护目标？|CRC32 / SHA256 / 数字签名 / 版本号各自的防护目标？]] ✅ 2026-08-12
